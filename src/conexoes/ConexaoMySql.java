...
public class ConexaoMySql {
    ...
    public Connection conectar(){
        try {
            ...
            String url = "jdbc:mysql://" + modelSessaoUsuario.ipServidor + "/" + modelSessaoUsuario.nomeDoBanco;
            this.setCon((Connection) DriverManager.getConnection(url, modelSessaoUsuario.usuarioBanco, modelSessaoUsuario.senhaBanco));
     ...
     public Connection conectarSemBanco(){
        try {
            //Driver do MySQL
            Class.forName("com.mysql.jdbc.Driver").newInstance();

            //local do banco, nome do banco, usuario e senha
            String url = "jdbc:mysql://" + modelSessaoUsuario.ipServidor;
            this.setCon((Connection) DriverManager.getConnection(url, modelSessaoUsuario.usuarioBanco, modelSessaoUsuario.senhaBanco));
