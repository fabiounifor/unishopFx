...
public class ModelContaReceber {
    ...
    private float valor;
    public String pesquisaReceber;
    private ArrayList<ModelContaReceber> listaContaReceber;
    ...
    */
    ...
    public ArrayList<ModelContaReceber> getListaContaReceber() {
        return listaContaReceber;
    }

    public void setListaContaReceber(ArrayList<ModelContaReceber> listaContaReceber) {
        this.listaContaReceber = listaContaReceber;
    }
    
    

    public String getPesquisaReceber() {
        ControllerCliente controllerCliente = new ControllerCliente();
        String nome = controllerCliente.getClienteControllerCod(codigoPessoa).getNome();
        return (nome + "   " + codigoPessoa +"   " + descricao +"   " + vencimento +"   " + situacao +"   " + valor);
    }

    public void setPesquisaReceber(String pesquisaReceber) {
        this.pesquisaReceber = pesquisaReceber;
    }
